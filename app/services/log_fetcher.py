...
class LogFetcherService:
    ...
    def _save_call_logs(self, db: Session, call_logs: List[Dict[str, Any]]) -> int:
        """
    ...
    def _save_message_logs(
        self, db: Session, message_logs: List[Dict[str, Any]]
    ) -> int:
        """
        ...
        for log_data in message_logs:
            ...
            log = Log(
                ...
                status=log_data.get("status"),
                error_code=str(log_data.get("error_code"))
    ...
    def _save_alert_logs(self, db: Session, alert_logs: List[Dict[str, Any]]) -> int:
        """
    ...
    def fetch_and_store_recent_logs(self, minutes: int = 5) -> Dict[str, int]:
        """
